...
let featureListingsPage, sharedListing;
...
test.describe("Searching with the same Listing", () => {
  ...
  test("Should search by keyword", async ({ page }) => {
    await featureListingsPage.searchInputField.fill(sharedListing.title);
    await featureListingsPage.startSearchButton.click();
  ...
  test("Should search by bedrooms", async ({ page }) => {
    await featureListingsPage.pickNumberOfBedrooms(sharedListing.bedrooms);
    await featureListingsPage.startSearchButton.click();
  ...
  test("Should search by city", async () => {
    await featureListingsPage.searchByCity.fill(sharedListing.city);
    await featureListingsPage.startSearchButton.click();
